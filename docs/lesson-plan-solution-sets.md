...
Stage 3 of the [Insight Discovery Gate](./INSIGHT_DISCOVERY_GATE.md). Built on the
PASS [Approved Insight Contract](./insights/solution-sets.md). Follows
[LESSON_DESIGN.md](./LESSON_DESIGN.md) and [MATH_CORRECTNESS.md](./MATH_CORRECTNESS.md).

## Approved insight (gate)
- Insight Contract: `docs/insights/solution-sets.md`
...
- [ ] Viewport/zoom checks; [LESSON_CORRECTNESS_CHECKLIST.md](./LESSON_CORRECTNESS_CHECKLIST.md).
- [ ] All tests pass.
