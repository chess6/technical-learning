...
[animation-quality-bar.md](./animation-quality-bar.md) sets the *authoring and
review* bar for clips and [LESSON_DESIGN.md](./LESSON_DESIGN.md) sets the lesson
...
[insight-brief-red-black-trees.md](./insight-brief-red-black-trees.md), primary insight
...
- Every corrected algorithm-visualization bug still gets a regression test and an
  `ERROR_LOG.md` entry, exactly as for the linear-algebra visuals.
- Score algorithm clips with the existing [clip-quality rubric](./animation-quality-bar.md#12-clip-quality-rubric);
