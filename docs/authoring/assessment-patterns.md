...
- [authoring/templates/lesson-mastery-contract.md §3](templates/lesson-mastery-contract.md#3-exercise-and-assessment-standard)
  and [authoring/mastery-standard.md §6](mastery-standard.md#6-assessment-architecture)
  ...
  **pattern library** those standards draw from. The three validation levels used
  ...
  [evidence levels E1–E7](mastery-standard.md#5-evidence-levels).
- [authoring/lesson-design.md](lesson-design.md) — the block palette
...
- [authoring/insight-discovery-gate.md](insight-discovery-gate.md) and
  [insights/karatsuba.md](../courses/algorithms/lessons/karatsuba/insight.md) — the causal chain a strong
...
- **Abstraction return (grounded insights).** When the insight was taught through a
  ...
  [grounding audit](insight-discovery-gate.md#audit-b--grounding--model-change-stage-2)),
