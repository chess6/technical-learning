...
[authoring/lesson-design.md](lesson-design.md) (choreography basics, safe frame, autoplay),
[product/vision.md](../product/vision.md) (educational
philosophy), and [engineering/math-correctness.md](../engineering/math-correctness.md) (geometry source of
truth).
...
(see [authoring/lesson-design.md](lesson-design.md#animation-choreography)).
...
- **Correctness constraint:** grid endpoints come only from the shared
  ...
  matrix pack (see [engineering/math-correctness.md](../engineering/math-correctness.md) and the
  transformed-grid entry in [quality/known-failure-modes.md](../quality/known-failure-modes.md)). Identity→\(A\)
...
- This project: `src/guided-scenes/scenes/sceneKit.ts`,
  `src/explorations/registry.tsx`, [authoring/lesson-design.md](lesson-design.md),
  [archive/lesson-depth-pattern.md](../archive/lesson-depth-pattern.md),
