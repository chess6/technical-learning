...
> [Course Mastery Standard](mastery-standard.md) and its per-lesson
> [Lesson Mastery Contract](templates/lesson-mastery-contract.md), completed **after** a
...
flowchart LR
  ...
  S2 --> S3["Stage 3: Lesson Plan (authoring/templates/lesson-plan.md)"]
  S2 -.->|"REVISE"| S1
```
...
Begins only after `Gate result: PASS`. Use [authoring/templates/lesson-plan.md](templates/lesson-plan.md).
...
- **Why the gate rewards it:** exposes hidden redundancy; reduces four recursive
  ...
  *N/A* (no real-world bridge is forced). Worked artifacts:
  [courses/algorithms/lessons/karatsuba/insight-brief.md](../courses/algorithms/lessons/karatsuba/insight-brief.md),
  [insights/karatsuba.md](../courses/algorithms/lessons/karatsuba/insight.md).
