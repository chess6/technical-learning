...
| L8 | Accumulating forever **(built; Gate 8 review open)** | An integral over an infinite interval is a **limit of finite accumulations**; convergence is a question about **decay rate**. Licenses every transform integral in the course. | `calculus-technique` | `improper-integrals` |
