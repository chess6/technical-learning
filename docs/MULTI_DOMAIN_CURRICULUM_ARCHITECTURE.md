...
- [INTERACTIVE_TEXTBOOK_VISION.md](./INTERACTIVE_TEXTBOOK_VISION.md) — §14 (the
...
INTERACTIVE_TEXTBOOK_VISION.md §14 exists only as a Mermaid diagram in prose.
...
- A `cross-domain-connection` edge is **advisory**: it never blocks access and
  ...
  concept-graph edges INTERACTIVE_TEXTBOOK_VISION.md §14 describes ("strengthen
