...
The final **learner-validation** layer of the [Insight Discovery Gate](./INSIGHT_DISCOVERY_GATE.md).
...
- **Validates:** the approved insight in [insights/karatsuba.md](./insights/karatsuba.md)
  (the Stage 2 contract). The lesson under test is
  [lesson-plans/karatsuba.md](./lesson-plans/karatsuba.md) /
...
- **Tone / accessibility:** follow [LESSON_DESIGN.md](./LESSON_DESIGN.md) — no leading
