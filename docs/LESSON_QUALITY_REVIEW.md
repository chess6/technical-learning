...
- [INSIGHT_DISCOVERY_GATE.md](./INSIGHT_DISCOVERY_GATE.md) — the upstream gate.
- [LESSON_DESIGN.md](./LESSON_DESIGN.md) — six-phase flow, continuity, tokens, a11y basics.
- [LESSON_CORRECTNESS_CHECKLIST.md](./LESSON_CORRECTNESS_CHECKLIST.md) and
  [MATH_CORRECTNESS.md](./MATH_CORRECTNESS.md) — correctness gates (feed hard blockers).
- [animation-quality-bar.md](./animation-quality-bar.md) — clip rubric (feeds
...
- **3** — Correct throughout; all geometry from `src/math`, edge/asymmetric cases covered, interpolations labeled honestly, verified against [MATH_CORRECTNESS.md](./MATH_CORRECTNESS.md).
...
- **2** — One idea per beat, establishing frame present, mostly meets [animation-quality-bar.md](./animation-quality-bar.md) (≥16/20).
...
- **Math incorrect in any learner-facing visualization or answer** — a wrong
  ...
  [LESSON_CORRECTNESS_CHECKLIST.md](./LESSON_CORRECTNESS_CHECKLIST.md)).
