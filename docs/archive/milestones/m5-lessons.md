...
([archive/milestones/visual-design-refinement.md](visual-design-refinement.md),
...
Complete [quality/lesson-correctness-checklist.md](../../quality/lesson-correctness-checklist.md) entries below for both lessons when shipping.
